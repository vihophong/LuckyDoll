...
bool CommandLineInterface::CheckFlags(uint argc, char* argv[], const bool& Debug)
{
  uint i,j;
...
ostream& operator <<(ostream &os,const CommandLineInterface &obj)
{
  ...
  for(uint i = 0; i < obj.fValues.size(); i++)
    {
	...
	{
	  cout<<obj.fFlags[i]<<": ";
	  for(uint j = 0; j < ((vector<char*>*) obj.fValues[i])->size(); j++)
	    {
	...
	{
	  cout<<obj.fFlags[i]<<": ";
	  for(uint j = 0; j < ((vector<string>*) obj.fValues[i])->size(); j++)
	    {
	...
	{
	  cout<<obj.fFlags[i]<<": ";
	  for(uint j = 0; j < ((vector<int>*) obj.fValues[i])->size(); j++)
	    {
	...
	{
	  cout<<obj.fFlags[i]<<": ";
	  for(uint j = 0; j < ((vector<long long>*) obj.fValues[i])->size(); j++)
	    {
	...
	{
	  cout<<obj.fFlags[i]<<": ";
	  for(uint j = 0; j < ((vector<double>*) obj.fValues[i])->size(); j++)
	    {
