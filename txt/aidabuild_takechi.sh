...
if [ $# == 4 ]; then
    ...
    # run
    ./aidanew -a list/list_R$4_$1_$2to$3.txt -o rootfiles/aidatakechinew/$4_aida$1_$2to$3.root -map config/FEE_table_briken2016.txt -thr config/thr_r141_1cps.txt -cal config/cal_briken2016_r25_26.txt -wi 5000
